...
- `leapp_btrfs_detected`
  - RHEL 8 Only
  - **Solves:** Btrfs has been removed from RHEL8. Comments btrfs entries in /etc/fstab, unmounts btrfs filesystems and unloads the btrfs kernel module.
...
- `leapp_multiple_devel_kernels_installed`
  - **Solves:** Multiple devel kernels installed. Removes all but the newest `kernel-devel` package.
